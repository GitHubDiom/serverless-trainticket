var appConsign = new Vue({
    ...
    methods: {
            ...
            $('#my-prompt').modal({
                ...
                onConfirm: function (e) {
                    ...
                    $.ajax({
                        ...
                        url: "/api/23bc46b1-71f6-4ed5-8c54-816aa4f8c502/orders/payForTheOrder",
                        contentType: "application/json",
                        headers: {"Authorization": "Bearer " + sessionStorage.getItem("client_token")},
                        dataType: "json",
                        data: data,
        ...
        searchRouteList() {
            ...
            this.queryForTravelInfo(travelQueryData, "http://owdev-apigateway.openwhisk:8080/api/23bc46b1-71f6-4ed5-8c54-816aa4f8c502/tickets/getLeftTripTickets");
        },
        checkNum(num) {
            if (num == "") {
                return false;
