...
public class SeatServiceImpl implements SeatService {
    ...
    private String function09_URI = "owdev-apigateway.openwhisk:8080//api/23bc46b1-71f6-4ed5-8c54-816aa4f8c502/route/getRouteByTripId";

    // private String function10_URI = "gateway.openfaas:8080/function/get-sold-tickets.openfaas-fn";
    private String function10_URI = "owdev-apigateway.openwhisk:8080/api/23bc46b1-71f6-4ed5-8c54-816aa4f8c502/ticket/getSoldTickets";

    // private String function11_URI = "gateway.openfaas:8080/function/get-traintype-by-tripid.openfaas-fn";
    private String function11_URI = "owdev-apigateway.openwhisk:8080/api/23bc46b1-71f6-4ed5-8c54-816aa4f8c502/trip/getTrainTypeByTripId";

    // private String function12_URI = "gateway.openfaas:8080/function/query-config-entity-by-config-name.openfaas-fn";
    private String function12_URI = "owdev-apigateway.openwhisk:8080/api/23bc46b1-71f6-4ed5-8c54-816aa4f8c502/configEntity/queryConfigEntityByConfigName";
    ...
    public mResponse getLeftTicketOfInterval(Seat seatRequest) {
        ...
        try {
            okhttp3.Request request = new okhttp3.Request.Builder()
                    .url("http://" + function09_URI + "/" + trainNumber)
                    .get()
                    .build();
    ...
    private double getDirectProportion() {
        ...
        try {
            okhttp3.Request request = new okhttp3.Request.Builder()
                    .url("http://" + function12_URI + "/" + configName)
                    .get()
                    .build();
